...
class ScoresController:
    ...
    def get_player_performance_by_game(self, player, game_name):
        possible_points = 0
        scored_points = 0
    ...
    def get_player_performance(self, player):
        ...
        for match_result in game_match_results:
            ...
            # it is assuming that the result_points were generated by generate_score_points
            scored_points += match_result.result_points
        return scored_points / possible_points
    ...
    def generate_game_standings(self, game_name):
        ...
        for player in players:
            ...
            players_score.append(score)
            players_performance.append(self.get_player_performance_by_game(player, game_name))
